...
if [[ -d "$ROOT_DIR/docs/templates" ]]; then
  ...
  cp -f "$ROOT_DIR/docs/templates/prd.md" "$TARGET_DIR/docs/04-projects/_templates/prd.md" 2>/dev/null || true
  cp -f "$ROOT_DIR/docs/templates/breadboard.md" "$TARGET_DIR/docs/04-projects/_templates/breadboard.md" 2>/dev/null || true
  cp -f "$ROOT_DIR/docs/templates/spike-plan.md" "$TARGET_DIR/docs/04-projects/_templates/spike-plan.md" 2>/dev/null || true
  cp -f "$ROOT_DIR/docs/templates/pack.md" "$TARGET_DIR/docs/04-projects/_templates/pack.md" 2>/dev/null || true
  cp -f "$ROOT_DIR/docs/templates/release-checklist.md" "$TARGET_DIR/docs/04-projects/_templates/release-checklist.md" 2>/dev/null || true
  cp -f "$ROOT_DIR/docs/templates/json-prd.schema.json" "$TARGET_DIR/docs/04-projects/_templates/json-prd.schema.json" 2>/dev/null || true
fi
