...
- `multi-agent-routing`: Route multi-agent work: choose sub-agents if supported, else parallel/serial sessions. Use when splitting tasks across multiple agents and client capability varies.
